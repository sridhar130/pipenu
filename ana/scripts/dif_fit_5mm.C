...
void dif_fit_5mm()
{
 ...
 TH1F * hist2 = gh1("/exp/mu2e/data/projects/pipenu/hist/tripathy/pipenu.bmup5b0s66r0105.tripathy_pipenu_pipenu_ana.hist","PipenuAna","trk_126/p_2");
 hist2->Rebin(2);
 ...
 hist2->SetTitle("mu+ DIF, exponential fit, 5mm ");
 hist2->Draw();

 // fitting----------

 TF1 * fB = new TF1("fB","exp((x* [p1])+[p0])",30,100);
 // fB->SetParameters(0,-20);
 fB->SetParameter(0,15.84);
 fB->SetParameter(1,-0.17);
 hist2->Fit("fB","SQ","",60.0,72.0);
