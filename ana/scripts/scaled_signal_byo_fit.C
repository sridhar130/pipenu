...
void scaled_signal_byo_fit()
{
 ...
 cbFit1->SetParameter(0, 68.94); // mean value
 ...
 cbFit1->SetParameter(2, 0.4684); // power law tail parameter
 cbFit1->SetParName(2,"alpha");
 //cbFit1->SetParLimits(2,1.0,2.0);
 cbFit1->SetParameter(3, 51.1); // power of the power law component (exponent)
 ...
 //cbFit1->SetParameter(4, 265); // normalization (peak height)
 //cbFit1->SetParName(4,"normt");
