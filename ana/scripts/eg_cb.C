...
void eg_cb()
{
 ...
 //fitting------------
 //crystalball_root
 TF1 * cbFit1 = new TF1("cbFit1, n =51.1",crystalball_root,64.0,70.0,5);
 TF1 * cbFit2 = new TF1("cbFit2, n=0.511",crystalball_root,64.0,70.0,5);
 TF1 * cbFit3 = new TF1("cbFit3, n=120000",crystalball_root,64.0,70.0,5);
 ...
 u_cbFit->SetParameter(0, 2.65e2); // normalization (peak height)
 ...
 u_cbFit->SetParameter(3, 0.46); // power law tail parameter
 u_cbFit->SetParName(3,"alpha");
 // u_cbFit->SetParLimits(3,1.0,2.0);
 u_cbFit->SetParameter(4, 20); // power of the power law component (exponent)
 ...
 cbFit1->SetParameter(1, 0.3157); // sigma
 cbFit1->SetParName(1,"sigma");
 //cbFit1->SetParLimits(1,0.2,0.4);
 cbFit1->SetParameter(2, 0.4684); // power law tail parameter //1.3
 cbFit1->SetParName(2,"alpha");
 //cbFit1->SetParLimits(2,1.0,2.0);
 cbFit1->SetParameter(3, 51.1); // power of the power law component (exponent) //52
 ...
 cbFit1->SetParameter(4, 2.65e2); // normalization (peak height) 2.65e-14
 cbFit1->SetParName(4,"normt");
...
// Set initial guesses for the parameters
 ...
 //hist1->Fit("cbFit1","I","",64.0,70.0);
 // hist1->Fit("u_cbFit","S","",64.0,70.0);
  cbFit3->SetParameters(68.9,0.3157,0.7684,120000.0,2.65e2);
  cbFit3->SetLineColor(4);
  c1->Divide(3,1);
  c1->cd(1);
  cbFit1->Draw();
  cbFit3->Draw("same");
  
  cbFit2->SetParameters(68.9,0.3157,0.4684,0.511,2.65e2);
  c1->cd(2);
  cbFit2->Draw();
