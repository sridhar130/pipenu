...
void bpip5_bmup5_select()
{
 gPipenu = new pipenu::Analysis("a");
 TCanvas *c1 = new TCanvas("c1"," ",900,750);

 TH1F * hist1 = gh1("/exp/mu2e/data/projects/pipenu/hist/tripathy/pipenu.bpip5b0s51r0105.tripathy_pipenu_pipenu_ana.hist","PipenuAna","trk_179/p_2");
 hist1->Rebin(2);
 ...
 TH1F * hist2 = gh1("/exp/mu2e/data/projects/pipenu/hist/tripathy/pipenu.bmup5b0s66r0105.tripathy_pipenu_pipenu_ana.hist","PipenuAna","trk_129/p_2");
 hist2->Rebin(2);
 // hist1->GetXaxis()->SetTitle("p (MeV/c)");
 hist2->Scale( gPipenu->GetChannel("bmup5b0s66r0100")->NormSF());
