...
void signal_byo_fit5mm()
{
 ...
 cbFit1->SetParameter(2, 0.4); // power law tail parameter //1.3
 cbFit1->SetParName(2,"alpha");
 //cbFit1->SetParLimits(2,0.8,2.0);
 cbFit1->SetParameter(3, 28.45); // power of the power law component (exponent) //52
 cbFit1->SetParName(3,"n");
 //cbFit1->SetParLimits(3,0.5,25.0);
 // cbFit1->SetParameter(4, 269.0); // normalization (peak height)
 // cbFit1->SetParName(4,"normt");
 // cbFit1->SetParLimits(4,268.0,275.0);

 cbFit1->SetParameter(4, 1.4e-14); // normalization (peak height) 2.65e-14
 cbFit1->SetParName(4,"normt");
 // cbFit1->SetParLimits(4,1.3e-14,1.5e-14);



 // cbFit1->SetLineColor(4);
 // cbFit1->Draw("same");
