f# -*- mode:org -*-
#+startup:fold
  *rpc01b0* : particle gun, 130 MeV photons converting at R=20cm nominal field
...
# ----------------------------------------------------------------------------------------------------
 ...
 - log files       : file:/exp/mu2e/data/projects/pipenu/log::/rpc01b0/
...
|              |                 |         |     factor |        |  / job |       |                 |        |         | /file |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| [[file:s1_sim_rpc01b0.fcl][s1_sim]]       | rpc01b0s00r0000 |   2.5e8 |          1 |        |      1 |   500 | rpc01b0s11r0000 |    500 |  650554 | 7400  |        | S1, everything relevant |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s2_sim       | rpc01b0s11r0000 |  650554 |          1 |     10 |      1 |   200 | rpc01b0s21r0000 |     10 |  312616 |       |        | TargetStopOutput        |
| s2_concat    | rpc01b0s21r0000 |  312616 |          1 |     10 |      5 |    40 | rpc01b0s21r0000 |      1 |  312616 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s3_gen_sim   | rpc01b0s21r0000 |  100000 |          1 |      1 |      1 |     1 | rpc01b0s31r0000 |        |   53124 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s4_digi_trig | rpc01b0s31r0000 |   53124 |          1 |      1 |      1 |     1 | rpc01b0s41r0000 |      1 |   53124 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_reco_kff  | rpc01b0s41r0000 |         |          1 |      1 |      1 |     1 | rpc01b0s51r0000 |      1 |         |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_stn_kff   | rpc01b0s51r0000 |         |          1 |      1 |      1 |     1 | rpc01b0s51r0000 |      1 |         |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_reco_kk   | rpc01b0s41r0000 |   53124 |          1 |      1 |      1 |     1 | rpc01b0s51r0100 |      1 |   53124 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_stn_kk    | rpc01b0s51r0100 |   53124 |          1 |      1 |      1 |     1 | rpc01b0s51r0100 |      1 |   53124 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|

* ---------------------------------------------------------------------------------------------------------------
* data formats                                                                                                
* ---------------------------------------------------------------------------------------------------------------
* dts.user.rpc01b0s41r0000.pipenu.art                                                                         
murat@mu2ebuild01:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s /exp/mu2e/data/projects/pipenu/datasets/rpc01b0s31r0000/murat/dts.murat.rpc01b0s31r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
   ...
   ******************************************************************
24-Mar-2024 10:29:18 CDT  Initiating request to open input file "/exp/mu2e/data/projects/pipenu/datasets/rpc01b0s31r0000/murat/dts.murat.rpc01b0s31r0000.pipenu.001210_00000000.art"
24-Mar-2024 10:29:19 CDT  Opened input file "/exp/mu2e/data/projects/pipenu/datasets/rpc01b0s31r0000/murat/dts.murat.rpc01b0s31r0000.pipenu.001210_00000000.art"
...
24-Mar-2024 10:29:21 CDT  Closed input file "/exp/mu2e/data/projects/pipenu/datasets/rpc01b0s31r0000/murat/dts.murat.rpc01b0s31r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
* dig.murat.rpc01b0s41r0000.pipenu.art                                                                        
murat@mu2ebuild02:/exp/mu2e/app/users/murat/muse_al9>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-06-06-08-42.s4_digi_trig_rpc01b0.mu2ebuild02.3736308/dig.mu2e.rpc01b0s41r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
     art v3_14_03    root v6_28_10a    KinKal v02_05_00b
     build  /exp/mu2e/app/users/murat/muse_al9
     build  al9-debug-e28-p056    06/06/24 08:27:08
   ******************************************************************
07-Jun-2024 09:45:19 CDT  Initiating request to open input file "results/2024-06-06-08-42.s4_digi_trig_rpc01b0.mu2ebuild02.3736308/dig.mu2e.rpc01b0s41r0000.pipenu.001210_00000000.art"
07-Jun-2024 09:45:20 CDT  Opened input file "results/2024-06-06-08-42.s4_digi_trig_rpc01b0.mu2ebuild02.3736308/dig.mu2e.rpc01b0s41r0000.pipenu.001210_00000000.art"
...
Found 0 data products in this Run
07-Jun-2024 09:45:21 CDT  Closed input file "results/2024-06-06-08-42.s4_digi_trig_rpc01b0.mu2ebuild02.3736308/dig.mu2e.rpc01b0s41r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
* mcs.mu2e.rpc01b0s51r0000.pipenu.art                                                                         
murat@mu2egpvm06:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-02-16-10-33.s5_reco_rpc01b0.mu2egpvm06.27620/mcs.mu2e.rpc01b0s51r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
     art v3_14_03    root v6_28_10a    KinKal v02_05_00b
     build  /exp/mu2e/app/users/murat/muse_002
     build  sl7-debug-e28-p055    02/16/24 08:30:49
   ******************************************************************
16-Feb-2024 11:08:47 CST  Initiating request to open input file "results/2024-02-16-10-33.s5_reco_rpc01b0.mu2egpvm06.27620/mcs.mu2e.rpc01b0s51r0000.pipenu.001210_00000000.art"
16-Feb-2024 11:08:49 CST  Opened input file "results/2024-02-16-10-33.s5_reco_rpc01b0.mu2egpvm06.27620/mcs.mu2e.rpc01b0s51r0000.pipenu.001210_00000000.art"
...
Found 0 data products in this Run
16-Feb-2024 11:08:55 CST  Closed input file "results/2024-02-16-10-33.s5_reco_rpc01b0.mu2egpvm06.27620/mcs.mu2e.rpc01b0s51r0000.pipenu.001210_00000000.art"
* ---------------------------------------------------------------------------------------------------------------
