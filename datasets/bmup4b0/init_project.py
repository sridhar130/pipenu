...
#------------------------------------------------------------------------------
    ...
    def __init__(self,idsid=None):
        ...
        #------------------------------------------------------------------------------
        self.fDataset['bmup4b0s00r0000'] = Dataset('generator'                               ,'bmup4b0s00r0000','local')
        #------------------------------------------------------------------------------
        # 2. input for stage2 : datasets produced by stage1
        #------------------------------------------------------------------------------
        self.fDataset['bmup4b0s11r0000'] = Dataset('sim.mu2e.bmup4b0s11r0000.art','bmup4b0s11r0000','local')
        self.fDataset['bmup4b0s12r0000'] = Dataset('sim.mu2e.bmup4b0s12r0000.art','bmup4b0s12r0000','local')
        #------------------------------------------------------------------------------
        # Input for stage3: datasets produced at stage2
        #------------------------------------------------------------------------------
        self.fDataset['bmup4b0s21r0000'] = Dataset('sim.mu2e.bmup4b0s21r0000.art','bmup4b0s21r0000','local') 
        self.fDataset['bmup4b0s22r0000'] = Dataset('sim.mu2e.bmup4b0s22r0000.art','bmup4b0s22r0000','local') 
        # Input s4 strip and s3 stn -- TargetStopOutput from s3
        self.fDataset['bmup4b0s31r0000'] = Dataset('sim.mu2e.bmup4b0s31r0000.art','bmup4b0s31r0000','local')
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------  
        job                          = s.new_job('stn_tgt','bmup4b0s21r0000');
...
#------------------------------------------------------------------------------        
        ...
        job                          = s.new_job('strip_mup','bmup4b0s21r0000');
