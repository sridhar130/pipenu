f# -*- mode:org -*-
#+startup:fold
  *bpip4b0* : trace only pions , TS3 collimator in a rotated position , Ti degrader of 2mm
# ----------------------------------------------------------------------------------------------------
 - directory       : file:./
...
|              |                 |         |     factor |        |  / job |       |                 |        |         | /file |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| [[file:s1_sim_bpip4b0.fcl][s1_sim]]       | bpip0b0s00r0000 |   2.5e8 |          1 |        |      1 |   500 | bpip4b0s11r0000 |    500 |  650554 |       |        | S1, everything relevant |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s2_sim       | bpip4b0s11r0000 |  650554 |          1 |     10 |      1 |   200 | bpip4b0s21r0000 |     10 |         |       |        | TargetStopOutput        |
|              |                 |         |            |        |        |       | bpip4b0s24r0000 |      1 |         |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s3_gen_sim   | bpip4b0s21r0000 |  100000 |          1 |      1 |      1 |     1 | bpip4b0s31r0000 |        |   52795 |       |        |                         |
|              | bpip4b0s24r0000 |  100000 |          1 |      1 |      1 |     1 | bpip4b0s34r0000 |        |    8742 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s4_digi_trig | bpip4b0s31r0000 |   52795 |          1 |      1 |      1 |     1 | bpip4b0s41r0000 |      1 |   52795 |       |        |                         |
|              | bpip4b0s34r0000 |    8742 |          1 |      1 |      1 |     1 | bpip4b0s44r0000 |      1 |    8742 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_reco_kk   | bpip4b0s41r0000 |   52795 |          1 |      1 |      1 |     1 | bpip4b0s51r0100 |      1 |   52795 |       |        |                         |
|              | bpip4b0s44r0000 |    8742 |          1 |      1 |      1 |     1 | bpip4b0s54r0100 |      1 |    8742 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_stn_kk    | bpip4b0s51r0100 |   52795 |          1 |      1 |      1 |     1 | bpip4b0s51r0100 |      1 |   52795 |       |        |                         |
|              | bpip4b0s54r0100 |    8742 |          1 |      1 |      1 |     1 | bpip4b0s54r0100 |      1 |    8742 |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_reco_kff  | bpip4b0s41r0000 |         |          1 |      1 |      1 |     1 | bpip4b0s51r0000 |      1 |         |       |        |                         |
|              | bpip4b0s44r0000 |         |          1 |      1 |      1 |     1 | bpip4b0s54r0000 |      1 |         |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| s5_stn_kff   | bpip4b0s51r0000 |         |          1 |      1 |      1 |     1 | bpip4b0s51r0000 |      1 |         |       |        |                         |
|              | bpip4b0s54r0000 |         |          1 |      1 |      1 |     1 | bpip4b0s54r0000 |      1 |         |       |        |                         |
|--------------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|

* ---------------------------------------------------------------------------------------------------------------
* data formats                                                                                                
* ---------------------------------------------------------------------------------------------------------------
* dts.user.bpip4b0s41r0000.pipenu.art                                                                         
murat@mu2egpvm06:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-02-16-09-29.s4_gen_sim_bpip4b0.mu2egpvm06.17759/dts.user.bpip4b0s41r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
   ...
   ******************************************************************
17-Feb-2024 09:53:23 CST  Initiating request to open input file "results/2024-02-16-09-29.s4_gen_sim_bpip4b0.mu2egpvm06.17759/dts.user.bpip4b0s41r0000.pipenu.001210_00000000.art"
17-Feb-2024 09:53:25 CST  Opened input file "results/2024-02-16-09-29.s4_gen_sim_bpip4b0.mu2egpvm06.17759/dts.user.bpip4b0s41r0000.pipenu.001210_00000000.art"
...
17-Feb-2024 09:53:29 CST  Closed input file "results/2024-02-16-09-29.s4_gen_sim_bpip4b0.mu2egpvm06.17759/dts.user.bpip4b0s41r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
* mcs.mu2e.bpip4b0s51r0000.pipenu.art                                                                         
