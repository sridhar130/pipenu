...
|             |                 |          |     factor |        |  / job |       |                 |        |          | /file |        |                          |
|-------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+----------+-------+--------+--------------------------|
| [[file:s1_sim_bmup9b0.fcl][s1_sim]]      | bmup9b0s00r0000 |      5e8 |          1 |        |      1 |   400 | bmum9b0s11r0000 |   3996 | 29502600 | 7400  |        | S1, everything relevant  |
|-------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+----------+-------+--------+--------------------------|
| s2_resample | bmum9b0s11r0000 | 29502600 |          1 |    200 |      1 |   200 | bmup9b0s24r0000 |        |          |       |        | no decay time constraint |
|             |                 |          |            |        |        |       | bmup9b0s25r0000 |        |          |       |        | decay [0, 50]            |
|             |                 |          |            |        |        |       | bmup9b0s26r0000 |        |          |       |        | decay [0,100]            |
|             |                 |          |            |        |        |       | bmup9b0s27r0000 |        |          |       |        | decay [0,150]            |
|             |                 |          |            |        |        |       | bmup9b0s28r0000 |        |          |       |        | decay [0,200]            |
|             |                 |          |            |        |        |       | bmup9b0s29r0000 |        |          |       |        | decay [0,300]            |
|-------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+----------+-------+--------+--------------------------|
