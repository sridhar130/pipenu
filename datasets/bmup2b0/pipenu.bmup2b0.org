f# -*- mode:org -*-
#+startup:fold
  *bmup2b0* : positive muon beam, 
  geometry: 2 mm Ti degrader in the beam, TS3 collimator rotated by 180 deg
  DS magnetic field 50% - think of Michel edge calibration
# ----------------------------------------------------------------------------------------------------
 - directory       : file:./
 - configuration   : [[file:./init_project.py][init_project.py]]
 - submitted jobs  : file:../AAA_SUBMITTED_JOBS
 - grid output     : file:/pnfs/mu2e/scratch/users/murat/workflow/pipenu.bmup2b0s00r0000.s1_sim/outstage
 - log files       : file:/exp/mu2e/data/projects/pipenu/log
 - catalogs        : file:./catalog
 - summary         : 
 - fcl             : 

- bmup2b0s11r000     : the same as bmup0b0s11r0000 : stage1 is common for all

# ----------------------------------------------------------------------------------------------------

|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| job             | input dsid      |  Nevents | Resampling | Nfiles | Nfiles | Njobs | output_dsid     | Nfiles | file   |  Nevents | N/file | comments                                |
|                 |                 |          |     factor |        |  / job |       |                 |        | size   |          |        |                                         |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| [[file:s1_sim_bmup2b0.fcl][s1_sim]]          | bmup2b0s00r0000 |      5e8 |          1 |        |      1 |  1000 | bmup2b0s11r0000 |   1000 | 3 MB   |  1523359 |   1500 | 1000x500,000                            |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| [[file:s2_resample_bmup2b0.fcl][s2_resample]]     | bmup2b0s11r0000 |  1523359 |       1000 |   1000 |      1 |  1000 | bmup2b0s24r0000 |    833 | 260 MB | 70615511 |  85000 |                                         |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| s3_digi_trig    | bmup2b0s24r0000 | 70615511 |          1 |    833 |      1 |   833 | bmup2b0s34r0000 |    833 | 410 MB | 70615511 |  85000 |                                         |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| s4_reco_kk      | bmup2b0s34r0000 | 70615511 |          1 |    833 |      2 |   417 | bmup2b0s44r0000 |    417 | 1.8 GB | 70615511 | 170000 |                                         |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| s4_stn_kk       | bmup2b0s44r0000 | 70615511 |          1 |    417 |     10 |    42 | bmup2b0s44r0000 |     42 | 1.6 GB | 70615511 |  1.76M |                                         |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
| s5_track_filter | bmup2b0s44r0000 | 70615511 |          1 |    417 |     20 |    21 | bmup2b0s54r0000 |     21 | 550 MB |   176163 |   8400 | events with at least one p>60 MeV track |
|-----------------+-----------------+----------+------------+--------+--------+-------+-----------------+--------+--------+----------+--------+-----------------------------------------|
...
* ------------------------------------------------------------------------------
* s1_sim                                                                     
  /pnfs/mu2e/scratch/users/murat/workflow/pipenu.bmup2b0s00r0000.s1_sim/outstage/53594253/00/00000:
  ...
  -rw-r--r--   1 murat mu2e    3408 Mar  9 20:15 cnf.murat.bmup2b0s00r0000_s1_sim.pipenu.00000_001210_00000000.fcl
  -rw-r--r--   1 murat mu2e  142148 Mar  9 20:16 log.murat.bmup2b0s00r0000_s1_sim.pipenu.00000_001210_00000000.log
  -rw-r--r--   1 murat mu2e 2104439 Mar  9 20:16 sim.murat.bmup2b0s11r0000.pipenu.001210_00000000.art
  -rw-r--r--   1 murat mu2e     986 Mar  9 20:17 sim.murat.bmup2b0s11r0000.pipenu.001210_00000000.art.json
  -rw-r--r--   1 murat mu2e 1789609 Mar  9 20:18 sim.murat.bmup2b0s12r0000.pipenu.001210_00000000.art
  -rw-r--r--   1 murat mu2e     985 Mar  9 20:19 sim.murat.bmup2b0s12r0000.pipenu.001210_00000000.art.json
* ---------------------------------------------------------------------------------------------------------------
* data formats                                                                                                
* ---------------------------------------------------------------------------------------------------------------
* sim.mu2e.pipenu.bmup2b0s11r0000.art                                                                         
#+begin_src 
murat@mu2egpvm06:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-03-09-09-46.cnf.murat.bmup2b0s00r0000_s1_sim.pipenu.00000_001210_00000000.mu2egpvm06.18888/sim.murat.bmup2b0s11r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
   ...
   ******************************************************************
09-Mar-2024 17:33:01 CST  Initiating request to open input file "results/2024-03-09-09-46.cnf.murat.bmup2b0s00r0000_s1_sim.pipenu.00000_001210_00000000.mu2egpvm06.18888/sim.murat.bmup2b0s11r0000.pipenu.001210_00000000.art"
09-Mar-2024 17:33:02 CST  Opened input file "results/2024-03-09-09-46.cnf.murat.bmup2b0s00r0000_s1_sim.pipenu.00000_001210_00000000.mu2egpvm06.18888/sim.murat.bmup2b0s11r0000.pipenu.001210_00000000.art"
...
09-Mar-2024 17:33:03 CST  Closed input file "results/2024-03-09-09-46.cnf.murat.bmup2b0s00r0000_s1_sim.pipenu.00000_001210_00000000.mu2egpvm06.18888/sim.murat.bmup2b0s11r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
#+end_src 
* sim.mu2e.pipenu.bmup2b0s21r0000.art                                                                         
#+begin_src 
murat@mu2egpvm06:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s21r0000.pipenu.001210_00000000.art
   ************************** Mu2e Offline **************************
     art v3_14_03    root v6_28_10a    KinKal v02_05_00b
     build  /exp/mu2e/app/users/murat/muse_002
     build  sl7-prof-e28-p055    03/09/24 16:44:22
   ******************************************************************
09-Mar-2024 17:35:23 CST  Initiating request to open input file "results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s21r0000.pipenu.001210_00000000.art"
09-Mar-2024 17:35:23 CST  Opened input file "results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s21r0000.pipenu.001210_00000000.art"
...
Found 0 data products in this Run
09-Mar-2024 17:35:25 CST  Closed input file "results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s21r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
#+end_src
* sim.mu2e.pipenu.bmup2b0s22r0000.art                                                                         
#+begin_src
murat@mu2egpvm06:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s22r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
     art v3_14_03    root v6_28_10a    KinKal v02_05_00b
     build  /exp/mu2e/app/users/murat/muse_002
     build  sl7-prof-e28-p055    03/09/24 16:44:22
   ******************************************************************
09-Mar-2024 17:37:07 CST  Initiating request to open input file "results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s22r0000.pipenu.001210_00000000.art"
09-Mar-2024 17:37:08 CST  Opened input file "results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s22r0000.pipenu.001210_00000000.art"
...
Found 0 data products in this Run
09-Mar-2024 17:37:09 CST  Closed input file "results/2024-03-09-15-26.s2_sim_bmup2b0.mu2egpvm06.470/sim.mu2e.bmup2b0s22r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
#+end_src
* ---------------------------------------------------------------------------------------------------------------
