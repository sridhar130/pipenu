...
#+startup:fold
  *bpim1bo* : dataset to generate pi- stops for the advanced degrader study
...
|           |                 |         |     factor |        |  / job |       |                 |        |         | /file |        |                         |
|-----------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| [[file:s1_sim_bpim1bo.fcl][s1_sim]]    | bpip0b0s00r0000 |   2.5e8 |          1 |        |      1 |   500 | bpim1bos11r0000 |    500 |  833951 |       |        | S1, everything relevant |
|           |                 |         |            |        |        |       | bpim1bos12r0000 |        |         |       |        | ignore                  |
|-----------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| [[file:s1_sim_concat.fcl][s1_concat]] | bpip0b0s11r0000 |  833951 |          1 |        |    500 |     1 | bpim1bos1xr0000 |      1 |  833951 |       |        | S1, everything relevant |
|-----------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| [[file:s2_sim_bpim1bo.fcl][s2_sim]]    | bpim1bos11r0000 |  833951 |          1 |    500 |     10 |    50 | bpim1bos21r0000 |     50 |     444 |       |        | TargetStopOutput        |
|           |                 |         |            |        |        |       | bpim1bos24r0000 |     50 |  817754 |       |        | DegraderStopFilterCH2   |
|           |                 |         |            |        |        |       | bpim1bos25r0000 |     50 |       0 |       |        | DegraderStopFilterPb    |
|-----------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|
| [[file:s2_concat_bpim1bo.fcl][s2_concat]] | bpim1bos21r0000 |         |          1 |     50 |     50 |     1 | bpim1bos21r0000 |      1 |     444 |       |        | TargetStopOutput        |
|           | bpim1bos24r0000 |         |          1 |     50 |     50 |     1 | bpim1bos24r0000 |      1 |  817754 |       |        | DegraderStopFilterCH2   |
|           | bpim1bos25r0000 |         |          1 |     50 |     50 |     1 | bpim1bos25r0000 |      1 |       0 |       |        | DegraderStopFilterPb    |
|-----------+-----------------+---------+------------+--------+--------+-------+-----------------+--------+---------+-------+--------+-------------------------|

* ---------------------------------------------------------------------------------------------------------------
* data formats                                                                                                
* ---------------------------------------------------------------------------------------------------------------
* dts.user.bpim1bos41r0000.pipenu.art                                                                         
murat@mu2egpvm06:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s results/2024-02-16-09-29.s4_gen_sim_bpim1bo.mu2egpvm06.17759/dts.user.bpim1bos41r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
   ...
   ******************************************************************
17-Feb-2024 09:53:23 CST  Initiating request to open input file "results/2024-02-16-09-29.s4_gen_sim_bpim1bo.mu2egpvm06.17759/dts.user.bpim1bos41r0000.pipenu.001210_00000000.art"
17-Feb-2024 09:53:25 CST  Opened input file "results/2024-02-16-09-29.s4_gen_sim_bpim1bo.mu2egpvm06.17759/dts.user.bpim1bos41r0000.pipenu.001210_00000000.art"
...
17-Feb-2024 09:53:29 CST  Closed input file "results/2024-02-16-09-29.s4_gen_sim_bpim1bo.mu2egpvm06.17759/dts.user.bpim1bos41r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
* mcs.mu2e.bpim1bos51r0000.pipenu.art                                                                         
murat@mu2ebuild01:/exp/mu2e/app/users/murat/muse_002>mu2e -c Offline/Print/fcl/dumpDataProducts.fcl -s /exp/mu2e/data/projects/pipenu/datasets/bpim1bos51r0000/murat/mcs.murat.bpim1bos51r0000.pipenu.001210_00000000.art 
   ************************** Mu2e Offline **************************
     art v3_14_03    root v6_28_10a    KinKal v02_05_00b
     build  /exp/mu2e/app/users/murat/muse_002
     build  sl7-prof-e28-p055    03/24/24 14:28:09
   ******************************************************************
24-Mar-2024 19:16:46 CDT  Initiating request to open input file "/exp/mu2e/data/projects/pipenu/datasets/bpim1bos51r0000/murat/mcs.murat.bpim1bos51r0000.pipenu.001210_00000000.art"
24-Mar-2024 19:16:47 CDT  Opened input file "/exp/mu2e/data/projects/pipenu/datasets/bpim1bos51r0000/murat/mcs.murat.bpim1bos51r0000.pipenu.001210_00000000.art"
...
Found 0 data products in this Run
24-Mar-2024 19:16:49 CDT  Closed input file "/exp/mu2e/data/projects/pipenu/datasets/bpim1bos51r0000/murat/mcs.murat.bpim1bos51r0000.pipenu.001210_00000000.art"
Art has completed and will exit with status 0.
* ---------------------------------------------------------------------------------------------------------------
