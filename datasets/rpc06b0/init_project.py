...
#-------v----------------------------------------------------------------------
        self.add_dataset(Dataset('generator'                          ,'rpc06b0s00r0000','local'))

        self.add_dataset(Dataset('sim.mu2e.rpc06b0s21r0000.pipenu.art','rpc06b0s21r0000','local'))
        self.add_dataset(Dataset('sim.mu2e.rpc06b0s24r0000.pipenu.art','rpc06b0s24r0000','local'))
        self.add_dataset(Dataset('sim.mu2e.rpc06b0s25r0000.pipenu.art','rpc06b0s25r0000','local'))
        self.add_dataset(Dataset('dts.mu2e.rpc06b0s34r0000.pipenu.art','rpc06b0s34r0000','local'))
        self.add_dataset(Dataset('dig.mu2e.rpc06b0s44r0000.pipenu.art','rpc06b0s44r0000','local'))
        self.add_dataset(Dataset('mcs.mu2e.rpc06b0s54r0100.pipenu.art','rpc06b0s54r0100','local'))
#------------------------------------------------------------------------------
...
# s5: reco_kk, reco_kff 
#-------v----------------------------------------------------------------------
        self.add_dataset(Dataset('dig.mu2e.rpc06b0s44r0000.pipenu.art','rpc06b0s41r0000','local'))
#------------------------------------------------------------------------------
# s5 : stn_kk, stn_kff
#-------v----------------------------------------------------------------------
        self.add_dataset(Dataset('mcs.mu2e.rpc06b0s54r0100.pipenu.art','rpc06b0s51r0100','local'))
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
    ...
    def __init__(self,idsid=None):
        ...
        ProjectBase.__init__(self,project='pipenu',family_id='rpc06b0',idsid=idsid);
        self.init_datasets();
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------  
#        job                          = s.new_job('stn_dts','rpc06b0s31r0000');
#
...
#------------------------------------------------------------------------------
# stage 4
# s4:digi_trig : InputDsID is 'rpc06b0s31r0000' 
...
#------------------------------------------------------------------------------
# stage 5
# s5:reco_kk : InputDsID is 'rpc06b0s41r0000' or 'rpc06b0s44r0000'
