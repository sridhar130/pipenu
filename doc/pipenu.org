...
* ------------------------------------------------------------------------------
* general                                                                    
- degrader is described in file:../../Offline/GeometryService/src/MECOStyleProtonAbsorberMaker.cc
- default parameters : file:../../Offline/Mu2eG4/geom/degrader_v02.txt
- extending degrader: rpc02b0 - 2-layered , with a CH2 disk and extra conversion ring at R=25
- parameters are stored in 
-  file:../../Offline/MECOStyleProtonAbsorberGeom/inc/MECOStyleProtonAbsorber.hh
...
* RPC on the modified degrader : file:rpc.org 
* ------------------------------------------------------------------------------
