# 
*------------------------------------------------------------------------------
* PIPENU datasets (summary)       last update : <2024-10-02 Wed>
* -----------------------------------------------------------------------------
...
|-----------+--------+-------------+-------------+-----------------------------------------+----------+----------------------------------------|
| [[file:../datasets/bpim0b0/pipenu.bpim0b0.org][bpim0b0]]   |  2.5e8 |             | pi- beam    | ShieldingM, pi decays OFF               | none     | input for RPC on degrader (CH2+Pb)     |
|-----------+--------+-------------+-------------+-----------------------------------------+----------+----------------------------------------|
| [[file:../datasets/bpim0b0/pipenu.bpim0b0.org][bpim1b0]]   |  2.5e8 |             | pi- beam    | ShieldingM, pi decays OFF               | none     | input for RPC on a CH2-only degrader   |
|-----------+--------+-------------+-------------+-----------------------------------------+----------+----------------------------------------|
...
|---------+--------+--------------------------------+-------------+------------------------------------------------------------------|
| [[file:../datasets/cele0b0/pipenu.cele0b0.org][cele0b0]] | xx     |                                | ok          | mu- --> e- conversion electrons on Al, LO, default geometry      |
| [[file:../datasets/cele1b0/pipenu.cele1b0.org][cele1b0]] | xx     |                                | ok          | mu- --> e- conversion electrons on Al, LL, default geometry      |
| [[file:../datasets/cele0b0/pipenu.cele0b0.org][cele2b0]] | xx     |                                | ok          | mu- --> e- conversion electrons on Al, LL, no TSdA4              |
| [[file:../datasets/cele0b0/pipenu.cele0b0.org][cele3b0]] | xx     |                                | ok          | mu- --> e- conversion electrons on Al, LO, degrader_v4           |
|---------+--------+--------------------------------+-------------+------------------------------------------------------------------|
| [[file:../datasets/neut0b0/pipenu.neut0b0.org][neut0b0]] | xx     |                                | ok          | neurton pileup, default geometry                                 |
| [[file:../datasets/neut1b0/pipenu.neut1b0.org][neut1b0]] | xx     |                                | ok          | neurton pileup, no TSdA                                          |
|---------+--------+--------------------------------+-------------+------------------------------------------------------------------|
| rpc00b0 |        |                                |             | test0: simualte RPC on H2 in Ti degrader                         |
| rpc01b0 |        |                                |             | test1: RPC on hydrogen, Rconverter = 20cm                        |
| rpc02b0 |        |                                |             | test1: RPC on hydrogen, Rconverter = 25cm                        |
| rpc03b0 |        |                                |             | RPC on hydrogen, converter v3 R=25cm, thickness=1.0 mm           |
| rpc04b0 |        |                                |             | RPC on hydrogen, converter v3 R=25cm, thickness=0.1 mm           |
| rpc05b0 |        |                                |             | RPC on hydrogen, converter v3 R=25cm, thickness=0.2 mm           |
| rpc06b0 |        |                                |             | RPC on CH2     , converter v3       , photons in the calorimeter |
| [[file:../datasets/rpc07b0/pipenu.rpc07b0.org][rpc07b0]] |        |                                |             | RPC on hydrogen, converter v4 R=25cm, dr=0.1mm                   |
|---------+--------+--------------------------------+-------------+------------------------------------------------------------------|
* *stntuples*                                      
